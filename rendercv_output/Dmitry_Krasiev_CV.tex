...
\begin{document}
    ...
    \section{Experience}
        ...
        \cventry{Sept. 2022 to present}{\textbf{Datafire}}{Frontend Developer, Junior-Middle}{Samara, Russia}{}{}
    ...
    \section{Technologies}
        ...
        \cvline{Languages}{JavaScript, HTML, CSS, Python}

        \cvline{Software}{Visual Studio Code, Neovim, Git, Postman, DBeaver, Jira, Confluence}
