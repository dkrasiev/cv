...
\usepackage[
    pdftitle={Dmitry Krasiev's CV},
    pdfauthor={Dmitry Krasiev},
    colorlinks=true,
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Dmitry Krasiev - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \textbf{Dmitry Krasiev}

        \vspace{0.3 cm}

        \normalsize
        \mbox{
            {\footnotesize\faMapMarker*}\hspace*{0.13cm}Your Location
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{mailto:youremail@yourdomain.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}youremail@yourdomain.com}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{tel:+90-541-999-99-99}{{\footnotesize\faPhone*}\hspace*{0.13cm}+90 541 999 99 99}
        }
        \kern 0.5 cm
        \mbox{
        ...
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{https://linkedin.com/in/yourusername}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}yourusername}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{https://github.com/yourusername}{{\footnotesize\faGithub}\hspace*{0.13cm}yourusername}
        }
        \kern 0.5 cm
    \end{header}
    ...
    \section{Publications}
        ...
        \begin{twocolentry}{
            ...
            \begin{minipage}{\linewidth}
                ...
                \mbox{Albert Smith}, \mbox{Dmitry Krasiev}, \mbox{Jane Derry}, \mbox{Harry Tom}, \mbox{Frodo Baggins}
                \vspace{0.10 cm}
